...
from scl.modules.dist_utils import all_gather
from scl.modules.objectives import compute_irtr_recall, compute_con_recall
from scl.gadgets.my_metrics import Accuracy, VQAScore, Scalar
import json
...
def epoch_wrapup(pl_module):
    ...
    if pl_module.hparams.config["get_recall_metric"] and not pl_module.training:
        ...
        # (ir_r1, ir_r5, ir_r10, tr_r1, tr_r5, tr_r10) = compute_con_recall(pl_module)
...
def set_schedule(pl_module):
    ...
    # head_names = ["vqa_classifier", "nlvr2_classifier", "snli_classifier", "mlm_score", "itm_score", "vision_proj", "language_proj"]
