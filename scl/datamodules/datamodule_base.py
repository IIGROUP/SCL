...
def get_pretrained_tokenizer(from_pretrained):
    if torch.distributed.is_initialized():
        if torch.distributed.get_rank() == 0:
            RobertaTokenizer.from_pretrained('/apdcephfs/share_1367250/auroraji/pretrained_weight/roberta_base')
        torch.distributed.barrier()
    return RobertaTokenizer.from_pretrained('/apdcephfs/share_1367250/auroraji/pretrained_weight/roberta_base')
